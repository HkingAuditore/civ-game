        ...
        <div className={`rounded-xl border p-3 ${tone}`}>
            <div className="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p className="mt-1 text-[11px] text-gray-400">{`\u5c06\u9886 ${side?.generalName || '\u672a\u4efb\u547d'}`}</p>
                </div>
    ...
    return (
        <section className="rounded-2xl border border-orange-900/40 bg-black/20 p-4">
            <div className="mb-3 flex items-center gap-2">
                ...
                <span className="rounded-full border border-orange-400/20 bg-orange-950/20 px-2 py-0.5 text-[10px] text-orange-200">
                        ...
                        <div key={battle.id} className="rounded-xl border border-orange-900/30 bg-gray-950/45 p-3">
                            ...
                            <div className="mt-3 rounded-xl border border-gray-800 bg-black/20 p-3">
                                <div className="mb-2 flex items-center justify-between gap-3">
                                    ...
                                    <p className="text-[10px] text-gray-500">{'\u5f53\u524d\u6218\u672f / \u5c06\u9886\u60c5\u51b5'}</p>
                                </div>
                                {lastLog?.events?.length ? (
                                    ...
                                    <p className="text-[11px] text-gray-500">{'\u4e0a\u4e00\u8f6e\u6682\u65e0\u989d\u5916\u6218\u62a5\u3002'}</p>
                                )}

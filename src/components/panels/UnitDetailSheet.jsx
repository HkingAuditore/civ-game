    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2 pb-2 border-b border-gray-700">
        <div className={`w-10 h-10 icon-metal-container icon-metal-container-lg rounded-lg flex items-center justify-center flex-shrink-0`}>
          <Icon name={unit.icon || 'Swords'} size={20} className={`${categoryInfo.color || 'text-red-400'} icon-metal-red`} />
        </div>
        <div className="flex-1 min-w-0">
<h2 className="text-base font-bold text-white leading-tight font-decorative">{unit.name}</h2>

    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-start gap-5 p-1">
                <div className={`flex-shrink-0 w-32 h-32 rounded-full ${building.visual.color} flex items-center justify-center icon-metal-container icon-metal-container-lg shadow-xl overflow-hidden border-4 border-white/10 ring-1 ring-black/50`}>
                    <Icon name={building.visual.icon} imagePath={building.visual.imagePath} size={'200%'} objectFit="cover" className={`${building.visual.text} icon-metal transform scale-125 hover:scale-150 transition-transform duration-700`} />
                </div>

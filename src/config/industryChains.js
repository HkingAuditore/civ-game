...
export const INDUSTRY_CHAINS = {
    ...
    military_chain: {
        id: 'military_chain',
        name: "军事产业链",
        desc: "从武器制造到军队维护的完整军事体系，随时代演进：工具→兵器→枪炮",
        unlockEpoch: 0,
        stages: [
            {
                stage: 'extraction',
                name: "原料供应",
                buildings: ['quarry', 'mine', 'copper_mine', 'coal_mine', 'saltpeter_mine'],
                output: ['stone', 'iron', 'copper', 'coal', 'saltpeter'],
                efficiency: 1.0,
                workers: ['miner'],
            },
            {
                ...
                name: "工具锻造",
                desc: "石器时代到青铜时代的基础武器",
                buildings: ['stone_tool_workshop', 'bronze_foundry', 'iron_tool_workshop'],
                input: ['wood', 'stone', 'copper', 'iron'],
                output: 'tools',
                efficiency: 1.0,
                workers: ['artisan', 'worker'],
                epochRange: [0, 1],
            },
            {
                stage: 'processing',
            ...
            },
            {
                ...
                desc: "工业时代的军事核心",
                buildings: ['arsenal'],
                input: ['steel', 'gunpowder', 'coal', 'tools'],
                output: 'firearms',
                efficiency: 1.0,
                workers: ['engineer', 'artisan', 'worker'],
                epochRange: [5, 6],
            },
            {
                stage: 'consumption',
                ...
                desc: "根据时代使用对应武器类型",
                consumers: ['military'],
                input: ['tools', 'weapons', 'gunpowder', 'firearms'],
                epochMap: {
                    0: ['tools'],
                    1: ['tools'],
                    2: ['weapons'],
                    3: ['weapons'],
                    4: ['weapons', 'gunpowder'],
                    5: ['firearms', 'gunpowder'],
                    6: ['firearms', 'gunpowder'],
                },
            },
            {
                stage: 'consumption',
        ...
        upgrades: [
            {
                ...
                name: "标准化武器",
                unlockEpoch: 2,
                cost: { iron: 200, tools: 100 },
                bonus: { efficiency: 0.20, cost: -0.10 },
            },
            {
                id: 'gunpowder_mastery',
                name: "火药精通",
                unlockEpoch: 4,
                cost: { saltpeter: 100, gunpowder: 50 },
                bonus: { efficiency: 0.25, quality: 0.15 },
            },
            {

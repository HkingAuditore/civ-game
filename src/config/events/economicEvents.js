    ...
    options: [
      {
        ...
        effects: {
          ...
          buildingProductionMod: { loom_house: 0.25, dye_works: 0.2 },
        },
      },
      {
        id: 'promote_local',
        ...
        effects: {
          ...
          buildingProductionMod: { loom_house: 0.3 },
        },
      },
      {
        id: 'sumptuary_laws',
    ...
    options: [
      {
        ...
        effects: {
          ...
          buildingProductionMod: { quarry: 0.2, lumber_camp: 0.15, brickworks: 0.15 },
        },
      },
      {
    ...
    options: [
      {
        ...
        effects: {
          ...
          stability: -5,
          buildingProductionMod: { military: 0.2, iron_tool_workshop: 0.15 },
        },
      },
      {
        id: 'moderate_buildup',
    ...
    options: [
      {
        ...
        effects: {
          ...
          buildingProductionMod: { gather: 0.05, brewery: 0.25 },
        },
      },
      {
        id: 'regulate_alcohol',
    ...
    options: [
      ...
      },
      {
        ...
        effects: {
          ...
          buildingProductionMod: { brickworks: 0.2 },
        },
      },
    ],
  },
    ...
    options: [
      {
        ...
        effects: {
          ...
          buildingProductionMod: { loom_house: 0.2, furniture_workshop: 0.25, delicacies_producer: 0.15 },
        },
      },
      {
        id: 'tax_luxury',
    ...
    options: [
      {
        ...
        effects: {
          ...
          resourcePercent: { science: 0.02 },
          buildingProductionMod: { coffee_plantation: 0.2, coffee_house: 0.15 },
        },
      },
      {
    ...
    options: [
      {
        ...
        effects: {
          ...
          buildingProductionMod: { furniture_workshop: 0.3 },
        },
      },
      {
        ...
        effects: {
          ...
          buildingProductionMod: { furniture_workshop: 0.15 },
        },
      },
      {
        id: 'discourage_waste',

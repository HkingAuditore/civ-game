    ...
    // ==================== 历史致敬场景 ====================
    {
        ...
        overrides: {
            ...
            popStructure: {
                ...
                merchant: 45, scribe: 36, official: 50, cleric: 24, soldier: 280, knight: 20, unemployed: 45,
            },
            maxPop: 1200, epoch: 4,
            techsUnlocked: EPOCH_4_TECHS,
            rulingCoalition: ['official', 'soldier', 'landowner'],
            legitimacy: 70, stability: 75,
            classWealth: { peasant: 200, serf: 60, landowner: 4000, worker: 300, artisan: 800, miner: 250, merchant: 3000, scribe: 1500, official: 4000, cleric: 1200, soldier: 600, knight: 3000, unemployed: 40 },
            classApproval: { peasant: 50, serf: 35, landowner: 80, worker: 55, artisan: 65, miner: 45, merchant: 70, scribe: 70, official: 85, cleric: 65, soldier: 80, knight: 85, unemployed: 25 },
    ...
    },
    {
        ...
        overrides: {
            ...
            popStructure: {
                ...
                merchant: 8, scribe: 6, cleric: 6, soldier: 220, knight: 25, unemployed: 15,
            },
            maxPop: 550, epoch: 3,
            techsUnlocked: EPOCH_3_TECHS,
            rulingCoalition: ['soldier', 'knight'],
            legitimacy: 40, stability: 45,
            classWealth: { peasant: 100, serf: 30, landowner: 2000, worker: 150, artisan: 400, miner: 120, merchant: 800, scribe: 400, cleric: 500, soldier: 400, knight: 2500, unemployed: 20 },
            classApproval: { peasant: 35, serf: 20, landowner: 60, worker: 40, artisan: 50, miner: 35, merchant: 50, scribe: 45, cleric: 50, soldier: 90, knight: 95, unemployed: 15 },
    ...
    },
    {
        ...
        overrides: {
            ...
            popStructure: {
                ...
                merchant: 20, scribe: 6, cleric: 9, soldier: 160, knight: 15, unemployed: 20,
            },
            maxPop: 500, epoch: 3,
            techsUnlocked: EPOCH_3_TECHS,
            rulingCoalition: ['soldier', 'navigator'],
            legitimacy: 30, stability: 40,
            classWealth: { peasant: 150, lumberjack: 200, worker: 180, serf: 50, navigator: 1500, merchant: 2000, scribe: 400, cleric: 600, soldier: 500, knight: 2000, unemployed: 30 },
            classApproval: { peasant: 45, lumberjack: 55, worker: 50, serf: 30, navigator: 80, merchant: 65, scribe: 40, cleric: 55, soldier: 85, knight: 90, unemployed: 25 },
    ...
    },
    {
        ...
        overrides: {
            ...
            popStructure: {
                ...
                merchant: 45, scribe: 9, cleric: 15, soldier: 350, knight: 100, unemployed: 55,
            },
            maxPop: 1000, epoch: 4,
            techsUnlocked: EPOCH_4_TECHS,
            rulingCoalition: ['knight', 'soldier'],
            legitimacy: 35, stability: 35,
            classWealth: { peasant: 80, serf: 30, landowner: 1500, lumberjack: 100, worker: 120, miner: 100, merchant: 2500, scribe: 300, cleric: 400, soldier: 400, knight: 3000, unemployed: 20 },
            classApproval: { peasant: 30, serf: 20, landowner: 55, lumberjack: 35, worker: 35, miner: 30, merchant: 60, scribe: 40, cleric: 45, soldier: 85, knight: 95, unemployed: 15 },
    ...
    },
    {
        ...
        overrides: {
            ...
            popStructure: {
                ...
                soldier: 380, knight: 20, unemployed: 275,
            },
            maxPop: 2200, epoch: 6,
            techsUnlocked: EPOCH_6_TECHS,
            rulingCoalition: ['capitalist', 'merchant', 'official'],
            legitimacy: 65, stability: 70,
            classWealth: { peasant: 600, worker: 800, artisan: 2000, miner: 600, engineer: 4000, capitalist: 80000, merchant: 20000, navigator: 6000, scribe: 3500, official: 8000, cleric: 3000, soldier: 1000, knight: 5000, unemployed: 150 },
            classApproval: { peasant: 45, worker: 50, artisan: 60, miner: 45, engineer: 70, capitalist: 90, merchant: 80, navigator: 75, scribe: 65, official: 75, cleric: 60, soldier: 70, knight: 75, unemployed: 30 },
    ...
    // ==================== 原有场景 ====================
    {
        ...
        overrides: {
            ...
            popStructure: {
                ...
                capitalist: 12, cleric: 9, soldier: 450, knight: 30, unemployed: 99,
            },
            maxPop: 1300, epoch: 4,
            techsUnlocked: EPOCH_4_TECHS,
            rulingCoalition: ['soldier', 'knight', 'landowner'],
            legitimacy: 25, stability: 30,
            classWealth: { peasant: 100, serf: 40, landowner: 2000, worker: 150, artisan: 400, miner: 120, capitalist: 5000, cleric: 600, soldier: 300, knight: 1800, unemployed: 25 },
            classApproval: { peasant: 30, serf: 25, landowner: 60, worker: 35, artisan: 45, miner: 35, capitalist: 55, cleric: 50, soldier: 75, knight: 80, unemployed: 20 },

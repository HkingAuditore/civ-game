...
export const BUILDINGS = [
...

    {
        ...
        jobs: { miner: 4, worker: 1, artisan: 1 },
        owner: 'artisan',
        epoch: 1,
        cat: 'gather',
    ...
    },
    {
        ...
        output: { silver: 15, culture: 1.2778 },

...
export const BUILDINGS = [
...

    {
        ...
        input: { coffee: 0.7999, delicacies: 0.4001 },
...

    {
        ...
        input: { coal: 1.08, ale: 0.54, delicacies: 0.27, science: 0.225 },
        output: { silver: 4.05, maxPop: 21 },
    ...
    },
    {
        ...
        input: { steel: 0.4, gunpowder: 0.5333 },
        output: { ammunition: 1.0667 },
    ...
    },
    {
        ...
        input: { steel: 1.20, coal: 0.80, science: 0.20, machinery: 0.10 },
...

    {
        ...
        input: { fine_clothes: 0.7143, delicacies: 0.5715, brick: 0.1427 },
...

    {
        ...
        output: { silver: 12.2667, culture: 1.2267 },
    ...
    },
    {
        ...
        input: { steel: 0.4091, iron: 0.5455, tools: 0.2727, electricity: 0.1364 },
        output: { machinery: 0.5455 },
        jobs: { worker: 11, engineer: 3, capitalist: 1 },
        owner: 'capitalist',
        epoch: 7,
        cat: 'industry',
    ...
    // ============ 信息时代 (Epoch 9) 新增建筑 ============
    {
        ...
        input: { electronics: 0.6273, chemicals: 0.4182, copper: 0.4182, stone: 0.2091, composites: 0.0418, electricity: 0.5227 },
        output: { semiconductors: 0.3136 },
    ...
    },
    {
        ...
        input: { semiconductors: 0.1278, electricity: 1.2778, steel: 0.1278, composites: 0.0767 },
        output: { silver: 10.2222, science: 1.2778 },
    ...
    },
    {
        ...
        input: { software: 0.2556, electricity: 0.5111 },
        output: { silver: 8.9444, culture: 1.2778 },

...
export const BUILDINGS = [
...

    {
        ...
        input: { fine_clothes: 0.09, brick: 0.02, dye: 0.02 }, // 降低输入消耗，使基础版人均净产出合理；添加染料需求增加dye早期消费
        output: { culture: 5.40 },
        jobs: { cleric: 3 },
        owner: 'cleric',
        epoch: 2,
...

    {
        ...
        jobs: { engineer: 4, scribe: 3, capitalist: 1 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'civic',
...

    {
        ...
        jobs: { cleric: 5, worker: 2, scribe: 1 },
        owner: 'cleric',
        epoch: 5,
        cat: 'civic',
    ...
    },
    {
        ...
        input: { coal: 1.0 },
        output: { electricity: 1.4 },
        jobs: { worker: 6, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 7,
        cat: 'industry',
    ...
    },
    {
        ...
        jobs: { worker: 5, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 7,
        cat: 'industry',
    ...
    },
    {
        ...
        input: { copper: 0.8, rubber: 0.3, electricity: 0.08 },
        output: { wiring: 0.5 },
    ...
    },
    {
        ...
        input: { steel: 0.3, iron: 0.4, tools: 0.2, electricity: 0.10 },
    ...
    },
    {
        ...
        output: { science: 4.20, culture: 2.00 },
    ...
    },
    {
        ...
        input: { uranium: 0.18, steel: 0.12, stone: 0.08 },
        output: { electricity: 4.5 },
    ...
    },
    {
        ...
        output: { plastics: 0.5 },
        jobs: { worker: 5, technician: 3, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
    ...
    },
    {
        ...
        input: { copper: 0.3, wiring: 0.3, chemicals: 0.2, stone: 0.2, electricity: 0.12 },
        output: { electronics: 0.3 },
        jobs: { technician: 5, worker: 4, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
    ...
    },
    {
        ...
        jobs: { technician: 3, scribe: 2, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
    ...
    },
    {
        ...
        jobs: { worker: 6, technician: 2, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
    ...
    },
    {
        ...
        input: { electronics: 0.2, plastics: 0.2, steel: 0.1, electricity: 0.2 },
        output: { electronics: 0.5 },
    ...
    },
    {
        ...
        output: { culture: 4.60, science: 1.60 },
    ...
    },
    {
        ...
        input: { electronics: 0.15, steel: 0.2, chemicals: 0.1, electricity: 0.15 },
        output: { ordnance: 0.3 },
        jobs: { worker: 6, technician: 3, engineer: 2 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'military',
    ...
    },
    {
        ...
        input: { synthetic_fiber: 2.0, dye: 0.5, electricity: 0.3 },
        output: { fine_clothes: 16.20 },
        jobs: { worker: 13, technician: 4, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
    ...
    // ============ 信息时代 (Epoch 9) 新增建筑 ============
    {
        ...
        input: { electronics: 0.3, chemicals: 0.2, copper: 0.2, stone: 0.1, composites: 0.02, electricity: 0.25 },
    ...
    },
    {
        ...
        input: { semiconductors: 0.05, electricity: 0.5, steel: 0.05, composites: 0.03 },
    ...
    },
    {
        ...
        jobs: { scientist: 3, scribe: 5, capitalist: 1 },
        owner: 'capitalist',
        epoch: 9,
        cat: 'civic',
    ...
    },
    {
        ...
        input: { stone: 0.08, aluminum: 0.06, composites: 0.04 },
        output: { electricity: 2.6 },
        jobs: { technician: 4, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 9,
        cat: 'industry',
    ...
    },
    {
        ...
        jobs: { technician: 4, worker: 3, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 9,
        cat: 'industry',
    ...
    },
    {
        ...
        input: { semiconductors: 0.05, electricity: 0.3, papyrus: 0.15, composites: 0.02 },
        output: { science: 8.00, culture: 1.40 },
        jobs: { scientist: 4, scribe: 2, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 9,
        cat: 'civic',
    ...
    },
    {
        ...
        jobs: { scientist: 5, technician: 3, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 9,
        cat: 'civic',
    ...
    },
    {
        ...
        output: { copper: 2.4, iron: 1.2, coal: 1.9, stone: 1.9 },

...
export const BUILDINGS = [
    ...
    // 纺织产业升级线
    {
        ...
        jobs: { worker: 14, artisan: 3, capitalist: 1 },
        owner: 'capitalist',
        epoch: 5,
        cat: 'industry',
    ...
    // 高级采集建筑
    {
        ...
        jobs: { miner: 13, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'gather',
...

    {
        ...
        output: { food: 48.0 },
        jobs: { peasant: 4, worker: 6, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'gather',
...

    {
        ...
        output: { wood: 46.80 },
        jobs: { lumberjack: 9, worker: 6, engineer: 1, capitalist: 1 },
        owner: 'capitalist',
        epoch: 6,
        cat: 'gather',

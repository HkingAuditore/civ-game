...
export const BUILDINGS = [
    ...
    // ===== V3 Mint Buildings (currency creation chain) =====
    {
        id: 'stone_mint',
        name: "贝壳采集处",
        desc: "在海岸或河滩采集贝壳，经筛选打磨后作为原始货币流通。产出的贝币进入国库。",
        ...
        epoch: 0,
        cat: 'civic',
        visual: { icon: 'Shell', color: 'bg-amber-800', text: 'text-amber-100' }
    },
    {
        id: 'mint',
        name: "铸币所",
        desc: "使用铜模和木炭炉铸造标准银币，是国家货币供应的基础设施。",
        baseCost: { stone: 80, copper: 40, plank: 30 },
        ...
        visual: { icon: 'Coins', color: 'bg-amber-600', text: 'text-amber-100' }
    },
    {
        id: 'royal_mint',
        name: "皇家铸币厂",
        desc: "由国家直接管控的大型铸币工厂，使用水力锻压技术大规模生产标准化货币。",
        baseCost: { brick: 200, copper: 100, coal: 50 },
        input: { copper: 0.8, coal: 0.2 },
        output: { silver: 8.0 },
        jobs: { worker: 5, artisan: 2, scribe: 1 },
        owner: 'state',
        epoch: 4,
        cat: 'civic',
        requiresTech: 'monetary_reform',
        visual: { icon: 'Coins', color: 'bg-yellow-600', text: 'text-yellow-100' }
    },
    {
        id: 'central_bank',
        name: "中央银行",
        desc: "现代金融体系的核心，通过纸币发行和信用扩张管理国家货币供应。",
        baseCost: { brick: 400, steel: 100, papyrus: 80 },
        input: { papyrus: 0.3 },
        output: { silver: 25.0 },
        jobs: { scribe: 6, capitalist: 2 },
        owner: 'state',
        epoch: 6,
        cat: 'civic',
        requiresTech: 'central_banking',
        visual: { icon: 'Landmark', color: 'bg-emerald-700', text: 'text-emerald-100' }
    },
    {
        id: 'federal_reserve',
        name: "联邦储备系统",
        desc: "最先进的货币管理机构，通过电子化手段精确调控货币供应量和利率。",
        baseCost: { steel: 300, electronics: 50, software: 30 },
        input: { electricity: 0.5 },
        output: { silver: 80.0 },
        jobs: { scribe: 10, capitalist: 3 },
        owner: 'state',
        epoch: 8,
        cat: 'civic',
        requiresTech: 'modern_monetary',
        visual: { icon: 'Landmark', color: 'bg-blue-800', text: 'text-blue-100' }
    },
...

    {
        ...
        input: { tools: 0.1666, food: 2.5 },
        output: { delicacies: 2.5 },
        jobs: { artisan: 3, worker: 2 },
        owner: 'artisan',
        epoch: 2,
        cat: 'industry',
...

    {
        ...
        input: { tools: 0.2, plank: 1.9999, cloth: 0.6 },
        output: { furniture: 2.4 },
...

    {
        ...
        input: { tools: 0.1, cloth: 2.5, dye: 0.5 },
        output: { fine_clothes: 2, culture: 0.8333 },
        jobs: { artisan: 3, worker: 2 },
        owner: 'artisan',
        epoch: 2,
        cat: 'industry',
...

    {
        ...
        input: { coal: 0.70, ale: 0.20, delicacies: 0.10, science: 0.10 },
        output: { maxPop: 30, food: 2 },
    ...
    },
    {
        ...
        input: { iron: 1.28, cloth: 0.64 },
        output: { plate_armor: 0.72 },
    ...
    },
    {
        ...
        input: { steel: 0.25, gunpowder: 0.5333 },
        output: { ammunition: 1.80 },
...

    {
        ...
        output: { fine_clothes: 14.00, culture: 0.90 },
    ...
    // 建材产业升级线
    {
        ...
        input: { stone: 7.2000, wood: 2.1000, coal: 0.7500 },
        output: { brick: 24.6000 },
...

    {
        ...
        input: { brick: 4.60, steel: 0.60, stone: 3.20, coal: 1.00 },
        output: { brick: 42.40 },
    ...
    // 高级文化建筑
    {
        ...
        output: { science: 5.20, culture: 1.20 },
...

    {
        ...
        input: { papyrus: 0.4907, coffee: 0.368 },
        output: { culture: 8, science: 3 },
        jobs: { scribe: 21, capitalist: 2 },
        owner: 'state',
        epoch: 6,
        cat: 'civic',
    ...
    // ============ 探索时代 (Epoch 4) 纺织链补充 ============
    {
        ...
        name: "棉花种植园",
        desc: "大规模种植棉花，为纺织业提供核心原料。殖民种植园经济的标志。",
        baseCost: { wood: 180, tools: 25, spice: 20 },
        input: {},
        output: { cotton: 2.4 },
        ...
        epoch: 4,
        cat: 'gather',
        requiresTech: 'cotton_cultivation',
        visual: { icon: 'Flower2', color: 'bg-amber-800', text: 'text-amber-100' }
    },
    {
        id: 'cotton_weaving_house',
        name: "棉纺织坊",
        ...
        cat: 'industry',
        requiresTech: 'cotton_cultivation',
        visual: { icon: 'Scissors', color: 'bg-amber-700', text: 'text-amber-100' }
    },
    ...
    // ============ 电气时代 (Epoch 7) 新增建筑 ============
    {
        ...
        visual: { icon: 'Droplet', color: 'bg-amber-950', text: 'text-amber-200' }
    },
    {
        ...
        input: { fertilizer: 0.1333 }, // E7 building, fertilizer required from base level
        output: { rubber: 1.3333 },
        jobs: { worker: 14, merchant: 1 },
        owner: 'merchant',
        epoch: 7,
        cat: 'gather',
        requiresTech: 'rubber_vulcanization',
        visual: { icon: 'Circle', color: 'bg-gray-700', text: 'text-gray-200' }
    },
    {
        id: 'coal_power_plant',
        name: "燃煤电厂",
        ...
        input: { coal: 1.6667 },
        output: { electricity: 2.3333 },
        jobs: { worker: 11, engineer: 3, capitalist: 1 },
        owner: 'capitalist',
        epoch: 7,
        cat: 'industry',
        requiresTech: 'power_generation',
        visual: { icon: 'Zap', color: 'bg-yellow-900', text: 'text-yellow-200' }
    },
    {
        id: 'oil_refinery',
        name: "炼油厂",
        ...
        input: { oil: 1.125, coal: 0.5625, dye: 0.1875 },
        output: { chemicals: 0.9375 },
        jobs: { worker: 10, engineer: 4, capitalist: 1 },
        owner: 'capitalist',
        epoch: 7,
        cat: 'industry',
        requiresTech: 'organic_chemistry',
        visual: { icon: 'Beaker', color: 'bg-green-900', text: 'text-green-200' }
    },
    {
        id: 'wiring_factory',
        name: "电缆厂",
        ...
        input: { copper: 1.5, rubber: 0.5625, electricity: 0.15 },
        output: { wiring: 0.9375 },
    ...
    },
    {
        ...
        input: { steel: 0.25, iron: 0.40, tools: 0.20, electricity: 0.12 },
        output: { machinery: 0.80 },
        jobs: { worker: 11, engineer: 3, capitalist: 1 },
        owner: 'capitalist',
        epoch: 7,
        cat: 'industry',
    ...
    },
    {
        ...
        input: { steel: 0.4, rubber: 0.3, machinery: 0.3, electricity: 0.15 },
        output: { automobile: 0.25 },
        jobs: { worker: 13, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 7,
        cat: 'industry',
        requiresTech: 'automobile_manufacturing',
        visual: { icon: 'Car', color: 'bg-blue-900', text: 'text-blue-200' }
    },
    {
        id: 'fertilizer_plant',
        name: "化肥厂",
        desc: "用化学品和煤生产化肥，供农业建筑消耗以提升产量。",
        baseCost: { silver: 1400, steel: 8, brick: 10 },
        input: { chemicals: 0.625, coal: 0.375 },
        output: { fertilizer: 2 },
        jobs: { worker: 11, engineer: 3, capitalist: 1 },
        owner: 'capitalist',
        epoch: 7,
        ...
        visual: { icon: 'Sprout', color: 'bg-green-800', text: 'text-green-200' }
    },
    {
        ...
        visual: { icon: 'Pickaxe', color: 'bg-orange-900', text: 'text-orange-200' }
    },
    {
        ...
        visual: { icon: 'Radio', color: 'bg-sky-900', text: 'text-sky-200' }
    },
    {
        ...
        visual: { icon: 'Layers', color: 'bg-purple-900', text: 'text-purple-200' }
    },
    {
        ...
        visual: { icon: 'Factory', color: 'bg-sky-800', text: 'text-sky-200' }
    },
    ...
    // ============ 原子时代 (Epoch 8) 新增建筑 ============
    {
        ...
        input: {},
        output: { uranium: 1.2667 },
        jobs: { worker: 12, technician: 6, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'gather',
        requiresTech: 'nuclear_physics',
        visual: { icon: 'Atom', color: 'bg-lime-900', text: 'text-lime-200' }
    },
    {
        ...
        input: { uranium: 0.38, steel: 0.2533, stone: 0.1689 },
        output: { electricity: 9.5 },
        jobs: { technician: 12, engineer: 6, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
        requiresTech: 'nuclear_power',
        visual: { icon: 'Atom', color: 'bg-lime-800', text: 'text-lime-100' }
    },
    {
        id: 'plastics_factory',
        name: "塑料厂",
        ...
        input: { chemicals: 0.76, oil: 0.57 },
        output: { plastics: 1.30 },
        jobs: { worker: 10, technician: 6, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
    ...
    },
    {
        ...
        input: { copper: 0.475, wiring: 0.475, chemicals: 0.3167, stone: 0.3167, electricity: 0.19 },
        output: { electronics: 0.475 },
        jobs: { technician: 8, worker: 7, engineer: 3, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
        requiresTech: 'integrated_circuits',
        visual: { icon: 'Cpu', color: 'bg-emerald-900', text: 'text-emerald-200' }
    },
    {
        ...
        input: { chemicals: 0.7714, papyrus: 0.5143 },
        output: { medicine: 0.6429 },
        jobs: { technician: 9, scribe: 6, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
    ...
    },
    {
        ...
        input: { stone: 0.95, coal: 0.57, electricity: 0.95 },
        output: { aluminum: 0.80 },
        jobs: { worker: 12, technician: 4, engineer: 2, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
        requiresTech: 'aluminum_smelting',
        visual: { icon: 'Layers', color: 'bg-slate-800', text: 'text-slate-200' }
    },
    {
        id: 'appliance_factory',
        name: "消费电子与家电厂",
        desc: "用电子元件、塑料和钢材制造家用电器与大众消费电子产品。",
        baseCost: { silver: 5000, steel: 30, electronics: 5 },
        input: { electronics: 0.3167, plastics: 0.3167, steel: 0.1583, electricity: 0.3167 },
        output: { electronics: 0.7917 },
        jobs: { worker: 13, technician: 5, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
        requiresTech: 'consumer_electronics',
        visual: { icon: 'Refrigerator', color: 'bg-blue-800', text: 'text-blue-100' }
    },
    {
        ...
        visual: { icon: 'Tv', color: 'bg-purple-900', text: 'text-purple-200' }
    },
    {
        id: 'high_rise_apartment',
        name: "高层公寓",
        desc: "钢筋混凝土高层住宅，需要稳定供电维持电梯、照明与城市生活。",
        baseCost: { silver: 3000, steel: 40, brick: 50, stone: 30 },
        input: { electricity: 0.08 },
        output: { maxPop: 130 },
        jobs: { worker: 2 },
        owner: 'capitalist',
        epoch: 8,
        ...
        visual: { icon: 'Building', color: 'bg-gray-700', text: 'text-gray-200' }
    },
    {
    ...
    {
        id: 'synthetic_textile_mill',
        name: "化纤纺织厂",
        desc: "使用化纤大规模生产高级成衣，纺织链终极节点。",
        baseCost: { steel: 400, brick: 350, tools: 200, science: 600 },
        input: { synthetic_fiber: 2.1111, dye: 0.5278, electricity: 0.3167 },
        output: { fine_clothes: 17.1 },
        jobs: { worker: 14, technician: 4, capitalist: 1 },
        owner: 'capitalist',
        epoch: 8,
        cat: 'industry',
        requiresTech: 'synthetic_textiles',
        visual: { icon: 'Shirt', color: 'bg-purple-800', text: 'text-purple-200' }
    },
    ...
    // ============ 信息时代 (Epoch 9) 新增建筑 ============
    {
        ...
        input: { electronics: 0.45, chemicals: 0.4182, copper: 0.4182, stone: 0.2091, composites: 0.0418, electricity: 0.5227 },
        output: { semiconductors: 0.56 },
        jobs: { technician: 12, scientist: 6, engineer: 4, capitalist: 1 },
        owner: 'capitalist',
        epoch: 9,
        cat: 'industry',
        requiresTech: 'semiconductor_manufacturing',
        visual: { icon: 'Cpu', color: 'bg-teal-900', text: 'text-teal-200' }
    },
    {
        id: 'software_company',
        name: "软件公司",
        ...
        visual: { icon: 'Code', color: 'bg-blue-900', text: 'text-blue-200' }
    },
    {
        id: 'data_center',
        name: "数据中心",
        ...
        input: { semiconductors: 0.10, electricity: 1.00, steel: 0.08, composites: 0.05 },
        output: { science: 12 },
        ...
        visual: { icon: 'Server', color: 'bg-gray-800', text: 'text-gray-200' }
    },
    {
        ...
        input: { software: 0.18, electricity: 0.5111 },
        output: { culture: 8, science: 3 },
        ...
        visual: { icon: 'Globe', color: 'bg-blue-800', text: 'text-blue-100' }
    },
    {
        ...
        visual: { icon: 'Sun', color: 'bg-amber-800', text: 'text-amber-200' }
    },
    {
        ...
        input: { plastics: 0.7667, aluminum: 0.5111, chemicals: 0.2556 },
        output: { composites: 0.6389 },
        jobs: { technician: 11, worker: 8, engineer: 3, capitalist: 1 },
        owner: 'capitalist',
        epoch: 9,
        cat: 'industry',
    ...
    },
    {
        ...
        visual: { icon: 'Microscope', color: 'bg-cyan-900', text: 'text-cyan-200' }
    },
    {
        id: 'financial_center',
        name: "金融中心",
        ...
        input: { software: 0.18, electricity: 0.5111 },
        output: { culture: 8, science: 5 },
        jobs: { scribe: 21, capitalist: 2 },
        owner: 'capitalist',
        epoch: 9,
        cat: 'civic',
        requiresTech: 'fintech',
        visual: { icon: 'Landmark', color: 'bg-amber-900', text: 'text-amber-200' }
    },
    {
        id: 'biotech_center',
        name: "生物科技中心",
        ...
        visual: { icon: 'Dna', color: 'bg-green-900', text: 'text-green-200' }
    },
    {
        id: 'automated_mine',
        name: "自动化矿场",

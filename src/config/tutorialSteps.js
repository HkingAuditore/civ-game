...
export const TUTORIAL_STEPS = [
    ...
    },
    {
        ...
        lead: '选择你的政治盟友',
        paragraphs: [
            '执政联盟是你选择与哪些社会阶层共同执政的核心政治系统。联盟的组成直接影响政府的合法性和统治效率。',
        ],
        cards: [
            {
                icon: 'Users',
            ...
            },
            {
                ...
                iconColor: 'text-emerald-400',
                title: '政府合法性',
                text: '联盟成员的总影响力占比决定合法性。合法性≥40%才是合法政府，影响税收效率和社会稳定。',
            },
            {
                icon: 'AlertCircle',
                iconColor: 'text-yellow-400',
                title: '联盟的代价',
                text: '联盟阶层期望更高：更低的税收容忍、更高的收入预期、对物资短缺更敏感，更容易不满。',
            },
        ],
        callouts: [
            {
    ...
    },
    {
        ...
        lead: '取之于民，用之于民',
        paragraphs: [
            '税收是国家财政的基础，但过度征税会损害经济活力。合理的税收政策是繁荣的关键。',
        ],
        cards: [
            {
                icon: 'User',
                iconColor: 'text-blue-400',
                title: '人头税',
                text: '按阶层日均收入的百分比征收。输入的数字就是实际税率百分比。收入越高税额越高，但过高会降低阶层满意度。',
            },
            {
                icon: 'Building',
                iconColor: 'text-emerald-400',
                title: '营业税',
                text: '按建筑营收（产值）的百分比征收，由业主支付。输入的数字就是实际税率百分比。可对不同建筑设置不同税率。',
            },
            {
                icon: 'Gift',
                iconColor: 'text-purple-400',
        ...
        callouts: [
            {
                ...
                icon: 'Lightbulb',
                title: '税收效率',
                text: '税收实际收入 = 应收税款 × 合法性效率。政府合法性越高，税收效率越高（最高100%）。',
            },
        ],
    },
    {
        ...
        lead: '发展经济的进阶技巧',
        paragraphs: [
            '随着文明发展，你可以升级建筑提升产出，但也要应对阶层日益增长的消费需求。',
        ],
        cards: [
            {
                icon: 'TrendingUp',
            ...
            },
            {
                ...
                iconColor: 'text-purple-400',
                title: '消费升级',
                text: '阶层积累财富后会解锁奢侈品需求。财富达到初始值1.5倍起逐级解锁香料、咖啡、珍馐等需求。',
            },
            {
                icon: 'BarChart',
                iconColor: 'text-yellow-400',
        ...
        callouts: [
            {
                ...
                icon: 'Check',
                title: '开局建议',
                text: '人口维护主要消耗食物与衣物（布料）。开局优先建造农田保障粮食，并尽早建设织布坊（或其他布料建筑）避免衣物短缺；木材不足时再补伐木场。随后再发展产业链，创造更多价值。',
            },
            {
                tone: 'info',
                icon: 'Gift',

...
// 基础配置
export { GAME_SPEEDS, RESOURCES, ECONOMIC_INFLUENCE, WEALTH_DECAY_RATE, TAX_LIMITS, TAX_BASE_RATES, LOG_STORAGE_LIMIT, HISTORY_STORAGE_LIMIT, DISCOVERY_CONFIG } from './gameConstants.js';

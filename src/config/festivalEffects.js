...
export const FESTIVAL_EFFECTS = {
    ...
    epoch0: [
        ...
        },
        {
            ...
            type: 'permanent',
            effects: {
                production: 0.03 // 全局生产 +3% (永久buff可叠加)
            },
    ...
    epoch3: [
        ...
        },
        {
            ...
            type: 'permanent',
            effects: {
                production: 0.03 // 生产效率 +3% (永久buff可叠加)
            },
    ...
    epoch4: [
        ...
        },
        {
            ...
            type: 'permanent',
            effects: {
                production: 0.025, // 永久buff可叠加
                scienceBonus: 0.02 // 永久buff可叠加
            },
        ...
        },
        {
            ...
            type: 'permanent',
            effects: {
                scienceBonus: 0.03, // 永久buff可叠加
                taxIncome: 0.035 // 永久buff可叠加
            },
        ...
        },
        {
            ...
            type: 'permanent',
            effects: {
                cultureBonus: 0.035, // 永久buff可叠加
                scienceBonus: 0.035, // 永久buff可叠加
            },
        ...
        },
        {
            ...
            type: 'permanent',
            effects: {
                militaryBonus: 0.04, // 永久buff可叠加
                industry: 0.025 // 永久buff可叠加
            },
    ...
    epoch6: [
        ...
        },
        {
            ...
            type: 'permanent',
            effects: {
                industry: 0.04, // 永久buff可叠加
                militaryBonus: 0.035, // 永久buff可叠加
                production: 0.025 // 永久buff可叠加
            },
        ...
        },
        {
            ...
            effects: {
                maxPop: 6, // 永久buff可叠加
                stability: 0.03, // 永久buff可叠加
                production: 0.02 // 永久buff可叠加
            },
        ...
        },
        {
            ...
            type: 'permanent',
            effects: {
                production: 0.035, // 永久buff可叠加
                industry: 0.05, // 永久buff可叠加
                scienceBonus: 0.035, // 永久buff可叠加
                cultureBonus: 0.025 // 永久buff可叠加
            },

...
创建了统一的配置文件 `growthConfig.js`，作为**所有增长率的唯一来源**。
...
// 或者直接使用乘数
const multiplier = DIFFICULTY_GROWTH_MULTIPLIERS['hard']; // 1.15
```
...
| `hard` | 1.15 | AI增长率 × 1.15 |
| `veryHard` | 1.3 | AI增长率 × 1.3 |
| `impossible` | 1.5 | AI增长率 × 1.5 |

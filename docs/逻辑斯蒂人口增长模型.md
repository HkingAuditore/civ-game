...
新的人口增长模型基于**逻辑斯蒂增长曲线（S-curve）**，这是一个科学且现实的人口增长模型，考虑了资源承载力的限制。
...
```javascript
// AI国家
intrinsicGrowthRate = 0.025 × tickScale × difficultyMultiplier

// 玩家国家
intrinsicGrowthRate = 0.003 × (1 + populationGrowthBonus)
```
